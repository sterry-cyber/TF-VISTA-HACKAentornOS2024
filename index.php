...
<div class="container">
	<div class="rupes">
		...
		<div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
			...
			<div class="rup-rgt">
				<h3>HASTA UN 70% DE DESCUENTO</h3>
				<h4><a href="offers.html">EN HOTELES EN TODO EL MUNDO</a></h4>
		...
		<div class="col-md-4 rupes-left wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">
			...
			<div class="rup-rgt">
				<h3>USD PLANO. 50% REBAJADO</h3>
				<h4><a href="offers.html">OFERTA DE APLICACIÓN DE EE. UU.</a></h4>
